                                            ...
                                            <div class='albumblock'>
                                                <div class='inner'>
                                                    <a href='/product/info.aspx?id=<%=item["id"] %>' target='_blank'>
                                                        <img src='<%=LibFile.get_img(item["tupian"].GetString(),"270","270") %>' alt='item["title"].GetString()' /></a><div class='albumtitle'><a href='/product/info.aspx?id=<%=item["id"] %>' target='_blank' title='item["title"].GetString()'><%=item["title"].GetString().Subs(10) %></a></div>
                                                </div>
                                            </div>
                                            <%} %>
                                        </ul>
